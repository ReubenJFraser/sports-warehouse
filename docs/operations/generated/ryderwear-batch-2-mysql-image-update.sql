...
WHERE model_id IN (
  ...
  'ryderwear_female_lift_2_0_shorts_foldover_ribbed_high_waisted',
  'ryderwear_female_contour_sports_bra_rib_waistband_light_support',
  'ryderwear_female_contour_shorts_foldover_ribbed_high_waisted',
  'ryderwear_female_contour_leggings_foldover_ribbed_high_waisted',
  'ryderwear_female_contour_track_pants_brushed_fleece_elastic_waistband_ankle_cuff',
  'ryderwear_female_sculpt_shorts_foldover_ribbed_high_waisted_scrunch',
  'ryderwear_female_sculpt_leggings_foldover_ribbed_high_waisted_scrunch',
  'ryderwear_female_ultra_tank_top_mesh',
