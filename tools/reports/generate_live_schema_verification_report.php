...
$runtimeDecisions = [
    'brand' => 'existing live column; keep as canonical CSV/camelCase import field',
    'gender' => 'existing live column; keep as canonical CSV/camelCase import field',
    ...
    'fabric' => 'existing live column; keep as canonical CSV/camelCase import field',
    'construction' => 'existing live column; keep as canonical CSV/camelCase import field',
    'seamless' => 'existing live column; keep as canonical CSV/camelCase import field',
    'scrunchFlag' => 'existing live column or compatibility alias acceptable; keep CSV field in import mapping',
    'invisibleFlag' => 'existing live column or compatibility alias acceptable; keep CSV field in import mapping',
    'neckline' => 'existing live column; keep as canonical CSV/camelCase import field',
    'strap_configuration' => 'existing live column; keep as canonical CSV/camelCase import field',
    'support_level' => 'existing live column; keep as canonical CSV/camelCase import field',
    'rise' => 'existing live column; keep as canonical CSV/camelCase import field',
    'length' => 'existing live column; keep as canonical CSV/camelCase import field',
    'variant' => 'existing live column; keep as canonical CSV/camelCase import field',
    'usage_category' => 'existing live column; keep as canonical CSV/camelCase import field',
    'usage_subtype' => 'existing live column; keep as canonical CSV/camelCase import field',
    'categoryName' => 'existing live column; keep as canonical CSV/camelCase import field',
    'parentCategory' => 'existing live column; keep as canonical CSV/camelCase import field',
    'ageGroup' => 'prefer CSV/camelCase; snake_case only compatibility alias pending approved rollout',
    'sizeType' => 'prefer CSV/camelCase; snake_case only compatibility alias pending approved rollout',
    'fitStyle' => 'prefer CSV/camelCase; snake_case only compatibility alias pending approved rollout',
    'activityTags' => 'prefer CSV/camelCase; snake_case only compatibility alias pending approved rollout',
    'price' => 'existing live column; keep as canonical CSV/camelCase import field',
    'salePrice' => 'existing live column; keep as canonical CSV/camelCase import field',
    'description' => 'existing live column; keep as canonical CSV/camelCase import field',
    'featured' => 'existing live column; keep as canonical CSV/camelCase import field',
    'images' => 'existing live column; keep as canonical CSV/camelCase import field',
    'thumbnails_json' => 'existing live column; keep as canonical CSV/camelCase import field',
    'external_item_id' => 'existing live column; keep as canonical CSV/camelCase import field',
    'campaign_or_series' => 'existing live column; keep as canonical CSV/camelCase import field',
    'altText' => 'existing live column; keep as canonical CSV/camelCase import field',
